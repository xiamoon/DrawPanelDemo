...
@property (nonatomic, copy, nullable) NSString *identifier; //!< 形状的唯一id

@property (nonatomic, strong, nullable) UkeGraphicEditInfo *editInfo;
@property (nonatomic, strong) NSSet *delete_ids;

@property (nonatomic, assign) BOOL showVertex; // 是否显示顶点及字母标记
